...
def get_args():
    ...
    parser.add_argument('--model_a_path',
                        default='/home/csudz/Desktop/dsm/file/dsm/project/IFKD/IFKD/outputs/at_vit2vit_snr7_C128/checkpoint-1999.pth',
                        help='resume from checkpoint')
...
def main(args):
    ...
    if args.model_a_path:
        checkpoint_a = torch.load(args.model_a_path, map_location='cpu', weights_only=False)
